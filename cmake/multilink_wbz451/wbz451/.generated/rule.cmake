...
function(multilink_wbz451_wbz451_wbz451_XC32_assemble_rule target)
    set(options
        ...
        "-g,-I${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/multilink_wbz451.X"
    ...
    target_include_directories(${target} PRIVATE "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/multilink_wbz451.X")
endfunction()
function(multilink_wbz451_wbz451_wbz451_XC32_assembleWithPreprocess_rule target)
    set(options
        ...
        "-mdfp=${PACK_REPO_PATH}/Microchip/PIC32CX-BZ_DFP/1.4.243/WBZ451"
        "-mprocessor=WBZ451"
        "-Wa,--defsym=__MPLAB_BUILD=1${MP_EXTRA_AS_POST},--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-I${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/multilink_wbz451.X")
    list(REMOVE_ITEM options "")
    target_compile_options(${target} PRIVATE "${options}")
...
function(multilink_wbz451_wbz451_wbz451_XC32_compile_rule target)
    ...
    target_include_directories(${target}
        ...
        PRIVATE "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/app_ble/handlers"
        PRIVATE "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/config/wbz451"
        PRIVATE "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/config/wbz451/ble/lib/include"
        PRIVATE "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/config/wbz451/ble/middleware_ble"
        ...
        PRIVATE "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/third_party/wolfssl"
        PRIVATE "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/third_party/wolfssl/wolfssl"
        PRIVATE "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/multilink_wbz451.X"
...
function(multilink_wbz451_wbz451_link_rule target)
    set(options
        ...
        "-Wl,--defsym=__MPLAB_BUILD=1${MP_EXTRA_LD_POST},--script=${multilink_wbz451_wbz451_LINKER_SCRIPT},--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=_min_heap_size=512,--gc-sections,-L${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/multilink_wbz451.X,-Map=mem.map,--memorysummary,memoryfile.xml"
        "-mdfp=${PACK_REPO_PATH}/Microchip/PIC32CX-BZ_DFP/1.4.243/WBZ451")
    list(REMOVE_ITEM options "")
